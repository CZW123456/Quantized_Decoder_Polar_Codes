...
def main():
    ...
    for EbN0dB in EbN0dBtest:
        ...
        polar_decoder = CAFastSCLLUTDecoder(N, K, A, L, frozenbits_indicator, messagebits_indicator, node_type, fs, gs, virtual_channel_llrs)
    ...
    # BER / BLER save path
    ber_save_dir = "simulation_result/BER/CA-FastSCLLUT"
    bler_save_dir = "simulation_result/BLER/CA-FastSCLLUT"

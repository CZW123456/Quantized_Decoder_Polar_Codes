...
from BitChannelMerge.UpgradingMerge import get_AWGN_transition_probability_upgrading
...
def main():
    ...
    load_dir = "./LUTs_UpgradMerge/N{:d}_K{:d}_Mu{:d}".format(N, K, mu)
    ...
    for EbN0dB in EbN0dBTest:
        ...
        W_AWGN, y_interval = get_AWGN_transition_probability_upgrading(sigma, mu // 2)
    ...
    # BER / BLER save path
    ber_save_dir = "simulation_result/BER/SCLUT_UpgradMerge"
    bler_save_dir = "simulation_result/BLER/SCLUT_UpgradMerge"

...
def main():
    ...
    polar_decoder_py = ConventionalDecoder.FastSCLDecoder.FastCASCLDecoder(N, K, 0, L, frozenbits, msgbits, node_type)
    polar_decoder = FastSCLDecoder(N, K, L, frozenbits_indicator, messagebits_indicator, node_type)
    ...
    # save BER/BLER
    ber_save_dir = "simulation_result/BER/FastSCL"
    bler_save_dir = "simulation_result/BLER/FastSCL"

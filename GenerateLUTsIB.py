...
def main():
    ...
    save_dir = "./LUTs_sIB/N{:d}_K{:d}_ChannelQ{:d}_DecoderQ{:d}_ChannelMMI".format(N, K, quantize_channel_MMI, quantize_decoder)
    ...
    for EbN0dB in EbN0dBTest:
        ...
        decoder_quantizer = ModifiedsIBSC(N, K, quantize_decoder)

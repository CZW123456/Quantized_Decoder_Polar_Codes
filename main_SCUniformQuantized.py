...
def main():
    ...
    polar_decoder = SCUniformQuantizedDecoder(N, K, frozen_indicator, message_indicator, decoder_r_f, decoder_r_g, v)
    ...
    # save BER/BLER
    ber_save_dir = "simulation_result/BER/SCUniformQuantized"
    bler_save_dir = "simulation_result/BLER/SCUniformQuantized"

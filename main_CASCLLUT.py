...
def main():
    ...
    parser.add_argument("--is_quantize_channel", type=bool, default=True)
    ...
    is_quantize_channel_MMI = args.is_quantize_channel
    quantize_channel_MMI = args.quantize_channel
    ...
    if is_quantize_channel_MMI:
        ...
        load_dir = "./LUTs/N{:d}_K{:d}_L{:d}_ChannelQ{:d}_DecoderQ{:d}_ChannelUniform".format(N, K, L, quantize_channel_uniform, quantize_decoder)
    ...
    for EbN0dB in EbN0dBTest:
        ...
        polar_decoder = CASCLLUTDecoder(N, K, A, L, frozenbits_indicator, messagebits_indicator, fs, gs, virtual_channel_llrs)
    ...
    # BER / BLER save path
    ber_save_dir = "simulation_result/BER/CA-SCLLUT"
    bler_save_dir = "simulation_result/BLER/CA-SCLLUT"
    ...
    if is_quantize_channel_MMI:
        ber_save_path = os.path.join(ber_save_dir, "N{:d}_K{:d}_L{:d}_ChannelQ{:d}_DecoderQ{:d}_ChannelMMI".format(N, K, L, quantize_channel_MMI, quantize_decoder))
        bler_save_path = os.path.join(bler_save_dir, "N{:d}_K{:d}_L{:d}_ChannelQ{:d}_DecoderQ{:d}_ChannelMMI".format(N, K, L, quantize_channel_MMI, quantize_decoder))
    else:
        ber_save_path = os.path.join(ber_save_dir, "N{:d}_K{:d}_L{:d}_ChannelQ{:d}_DecoderQ{:d}".format(N, K, L, quantize_channel_MMI, quantize_decoder))
        bler_save_path = os.path.join(bler_save_dir, "N{:d}_K{:d}_L{:d}_ChannelQ{:d}_DecoderQ{:d}".format(N, K, L, quantize_channel_MMI, quantize_decoder))

...
setup(
    ...
    version=VERSION,
    author="CaoZhiWei",
    description=("Implement MMI quantizer for decoding Polar codes"),
    license="WTF",
    packages=find_packages(include=("quantizers*", )),
    ext_modules=[CMakeExtension("quantizers._cpp._libQuantizer")],
    install_requires=[
        'numpy',
    ],
